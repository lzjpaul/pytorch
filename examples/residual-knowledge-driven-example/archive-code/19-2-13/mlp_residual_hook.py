...
def train_validate_test_resmlp_model_MNIST(model, gpu_id, train_loader, test_loader, criterion, optimizer, max_epoch=25):
...
if __name__ == '__main__':
    ...
    train_validate_test_resmlp_model_MNIST(model_ft, gpu_id, train_loader, test_loader, criterion, optimizer_ft, max_epoch=args.maxepoch)

# python mlp_residual_hook.py -datadir . -modelname resnetmlp3 -batchsize 64 -maxepoch 10 -gpuid 1
