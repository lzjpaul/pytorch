...
def sub_matrix(corr_abs, w_array, index, output_dir):
    ...
    print ("processing: ", output_dir + '_' + str(index))
    print ("bottom_weight_values average: ", np.average(bottom_weight_values))
    print ("top_weight_values average: ", np.average(top_weight_values))
    print ("bottom_weight_ratios average: ", np.average(bottom_weight_ratios))
    print ("top_weight_ratios average: ", np.average(top_weight_ratios))
